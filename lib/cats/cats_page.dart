...
import 'package:cat_facts/widget_helper/custom_circular_progress.dart';
import 'package:cat_facts/widget_helper/cutom_button.dart';
import '../main.dart';
...
class _CatsPageState extends State<CatsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor: white, appBar: _appBar(), body: _buildBody());
  }
  ...
  AppBar _appBar() {
    return AppBar(
      ...
      elevation: 0,
      centerTitle: true,
      title: Text('Cat Facts', style: StyleText.blackText(22, FontWeight.w700)),
      actions: [
        CustomButton(
          ...
          tooltip: 'Cats history',
          leading: const Icon(Icons.history, color: black, size: 26),
        )
      ],
    );
  }
                    ...
                    children: [
                      ...
                      AnimatedPositioned(
                        ...
                        child: CustomButton(
                          ...
                          width: size.width * .4,
                          tooltip: 'There are not many cats',
    ...
    return Column(
      children: [
        Container(
          ...
          child: ClipRRect(
            borderRadius: BorderRadius.circular(size.width * .05),
            child: Image.network('https://cataas.com$url',
  ...
  Widget _catFact(CatsLoaded state) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: size.width * .1)
          .copyWith(top: size.height * .03),
      child: Column(
        children: [
          Text(
            'Random fact about cats:',
            style: StyleText.blackText(16, FontWeight.w400, underline: true),
          ),
          Padding(
          ...
          Text(
            state.cat!.date!,
            style: StyleText.blackText(14, FontWeight.w200),
            textAlign: TextAlign.center,
          ),
        ],
      ),
